            ...
            <Alert
              ...
              message={
                <div className="d-flex justify-content-between align-items-center">
                    ...
                    <br></br>
                  {notification.title[0] === '#' && <small>Click on this blue banner to navigate to Interview</small>}
                    </div>
                  <span className="underline" onClick={()=>changeStatus(notification.id , 'read')}>Mark as read</span>
                </div>
              }
            />
          ))}
            ...
            <Alert
              ...
              message={
                <div className="d-flex justify-content-between align-items-center">
                  ...
                  <span className="underline" onClick={()=>changeStatus(notification.id , 'unread')}>Mark as unread</span>
                </div>
              }
            />
          ))}
